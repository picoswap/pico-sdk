...
describe('Router', () => {
  ...
  const pair_weth_0 = new Pair(new TokenAmount(WETH9[ChainId.EDGEWARE], '1000'), new TokenAmount(token0, '1000'))
    ...
    describe('exact in', () => {
      it('edg to token1', () => {
        ...
        expect(result.args.slice(0, -1)).toEqual([
          '0x51',
          [WETH9[ChainId.EDGEWARE].address, token0.address, token1.address],
      ...
      it('token1 to edg', () => {
        const result = Router.swapCallParameters(
          Trade.exactIn(
            new Route([pair_0_1, pair_weth_0], token1, EDG_CURRENCY),
        ...
        expect(result.args.slice(0, -1)).toEqual([
          '0x64',
          '0x51',
          [token1.address, token0.address, WETH9[ChainId.EDGEWARE].address],
          '0x0000000000000000000000000000000000000004'
        ])
